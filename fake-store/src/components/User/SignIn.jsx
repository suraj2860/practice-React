...
function SignIn() {
    ...
    const handleSignin = () => {
        if (username && password) {
            fetch('https://api.freeapi.app/api/v1/users/login', {
                method: 'POST',
                headers: {
                ...
                <div className="flex flex-row w-full">
                    ...
                    <div className="hidden lg:flex flex-col justify-between bg-gray-900 text-white lg:p-8 xl:p-12 lg:max-w-sm xl:max-w-lg">
                        ...
                        <div className="space-y-5">
                            ...
                            <Link to={'/register'}><button className="inline-block flex-none px-4 py-3 border-2 rounded-lg font-medium border-black bg-yellow-600 text-black">
                                Create account here
                            </button></Link>
                        </div>
                    ...
                    <div className="flex flex-1 flex-col items-center justify-center px-10 relative">
                        ...
                        <div className="flex flex-1 flex-col  justify-center space-y-5 w-2/4">
                            ...
                            <div className="flex flex-col max-w-md space-y-5">
                                ...
                                {/* <Link to={response && response.status === 'success' ? '/home' : '/'} onClick={handleSignin} className="flex items-center justify-center flex-none px-3 py-2 md:px-4 md:py-3 border-2 rounded-lg font-medium border-black bg-black text-white"> */}
                                    <button onClick={(e) => handleSignin(e)} className="flex items-center justify-center flex-none px-3 py-2 md:px-4 md:py-3 border-2 rounded-lg font-medium border-black bg-black text-white">
                                        Sign in
                                    </button>
                                    {/* </Link> */}
